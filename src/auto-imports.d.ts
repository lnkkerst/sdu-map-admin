...
declare global {
  ...
  const useMapStore: typeof import('./store/newMap')['useMapStore'];
...
declare module '@vue/runtime-core' {
  interface ComponentCustomProperties {
    ...
    readonly useMapStore: UnwrapRef<
      typeof import('./store/newMap')['useMapStore']
    >;
    ...
    >;
    readonly useSetting: UnwrapRef<
      typeof import('./composables/setting')['useSetting']
    >;
